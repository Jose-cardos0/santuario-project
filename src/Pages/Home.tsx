  ...
  return (
    <main className="bg-custom-gray">
      ...
      <section
       ...
       w-full h-auto flex items-center
       justify-center m-auto py-14 overflow-hidden"
      >
          ...
          <div className="relative h-auto">
            ...
            <div className="max-w-7xl ">
              <p className="text-justify mt-8 w-2/3 font-roboto mm:max-md:w-full mm:max-md:px-8">
                ...
                iusto ducimus ipsam delectus necessitatibus quaerat. Atque,
                dicta laborum voluptatem quis placeat numquam temporibus maxime
                quae, iste perferendis, animi itaque laboriosam quam porro ullam
                ipsum. Excepturi voluptatibus dignissimos possimus eum tenetur
                aut vitae error voluptate nobis? Veritatis nobis repellendus
                expedita aliquid quis esse earum minus perspiciatis consequuntur
                non? Quo reiciendis maxime assumenda odio atque velit harum, nam
                alias ut culpa sapiente dolorum mollitia, iusto iure! Fugit.
                Voluptatum sint ratione, quaerat quod in deleniti hic
                dignissimos id quam exercitationem rem, delectus, libero veniam
                atque sunt aperiam assumenda eligendi nostrum. Iste odio dolore
                amet consequatur deserunt culpa ducimus! Facilis, ullam atque
                nobis illum iste voluptatum quisquam doloribus magnam maiores
                hic incidunt asperiores officia, qui aliquam. Ut eos velit
                excepturi corrupti, totam ipsum expedita magnam assumenda, aut
                sed dolorem. Ab iusto autem earum, rem deleniti laboriosam saepe
                sunt accusantium esse sapiente. Culpa a nisi, quos facilis saepe
                cum est magni asperiores quisquam quibusdam animi natus
                veritatis, consequatur obcaecati ab? Asperiores cum eos
                consequatur architecto dignissimos a in repellat? Fuga, nemo,
                ullam ratione eveniet voluptates libero, deserunt labore fugit
                accusantium dolores quas. Excepturi, ea odit. Est et unde nisi
                repudiandae. Tenetur earum exercitationem assumenda cupiditate
                quia asperiores placeat reiciendis quidem, quae, delectus
                aliquam vitae sapiente illum recusandae nihil vel molestiae vero
                explicabo et? Provident harum numquam neque eligendi error
                impedit. Voluptatum delectus fugit sunt corporis, excepturi
                reprehenderit, ipsum maxime iste sit eius dolor provident facere
                eveniet similique, perspiciatis magnam? Doloribus modi, sapiente
                repudiandae temporibus impedit totam possimus earum vel
                explicabo? Pariatur nam voluptate impedit, exercitationem aut
                libero quibusdam asperiores dolor quod iure minima, facere ex
                qui itaque vitae totam sunt! Praesentium sint dignissimos ullam
                neque impedit corporis perferendis quod voluptatem. Quis beatae
                error reprehenderit magnam tempora, placeat aperiam doloribus
                asperiores neque dolorem in exercitationem architecto sunt enim
                expedita nostrum corrupti velit labore quas animi autem esse.
                Adipisci veritatis quam
              </p>
            </div>
          </div>
        </AnimatedY>
      ...
      {/*IMAGENS */}
      <section
        className="bg-cutom-gray-strong pb-12 overflow-hidden
           "
      >
        <AnimatedNegative>
          <div
